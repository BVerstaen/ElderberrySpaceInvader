	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color16 = IsGammaSpace() ? float4( 1, 0.2396226, 0.2396226, 0 ) : float4( 1, 0.04682013, 0.04682013, 0 );
				...
				float4 lerpResult55 = lerp( color16 , tex2DNode15 , ( input.ase_texcoord3.w + _Float0 ));
